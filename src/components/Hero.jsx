...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      {/* Overlay gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-black/70 z-10 pointer-events-none" />
      ...
      <div className="absolute inset-0 z-20 px-6 md:px-12 max-w-7xl mx-auto flex items-center w-full h-full pt-16 md:pt-20">
        <div className="flex flex-col items-start text-left max-w-lg lg:max-w-xl w-full">
          ...
          <h2
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-xl md:text-2xl lg:text-3xl font-bold text-[#ff2a2a] mb-5 tracking-wide"
          >
            BCA Student
          </h2>
          ...
          <p 
            data-aos="fade-up"
            data-aos-delay="300"
            className="text-white/80 text-sm md:text-base lg:text-lg font-medium mb-8 max-w-md leading-relaxed"
          >
          ...
          >
            <a 
              href={resumePdf}
              download
              className="group inline-flex items-center gap-2 px-6 py-3 text-sm rounded-full bg-[#ff2a2a] text-white font-bold hover:bg-white hover:text-[#ff2a2a] transition-all duration-300 transform hover:-translate-y-0.5 shadow-[0_8px_25px_rgba(255,42,42,0.35)]"
            >
            ...
            <a 
              href="#projects" 
              className="px-6 py-3 text-sm rounded-full bg-white text-black font-bold hover:bg-neutral-100 transition-all duration-300 transform hover:-translate-y-0.5 shadow-xl"
            >
              View My Work
            </a>
            <a 
